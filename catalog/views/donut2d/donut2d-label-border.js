...
/**
 * Create Donut2D with border labels
 * 
 * @param container
 * @param width
 * @param height
 */
function createDonut2DLabelBorder(container, width, height) {
	...
	var s2Label = new JenScript.Donut2DBorderLabel({
		text : "Platinium"
	});
	s2.addSliceLabel(s2Label);

	var s3Label = new JenScript.Donut2DBorderLabel({
		text : "Rhodium"
	});
	s3.addSliceLabel(s3Label);

	var s4Label = new JenScript.Donut2DBorderLabel({
		text : "Gold"
	});
	s4.addSliceLabel(s4Label);

	var s5Label = new JenScript.Donut2DBorderLabel({
		text : "Uranium"
	});
