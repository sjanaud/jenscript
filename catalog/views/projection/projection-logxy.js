...
/**
 * Create LogXY projection with Label plugin
 * @param container
 * @param width
 * @param height
 */
function createLogXYProjection(container, width, height) {
	...
	// LogX (= LogX Linear Y) projection. log requirement: x >0 and y>0
	var proj = new JenScript.LogXLogYProjection({
		name : "proj log x y",
		minX : 0.001,
		maxX : 1000,
		minY : 0.001,
