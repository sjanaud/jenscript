...
/**
 * Create LogY projection with Label plugin
 * @param container
 * @param width
 * @param height
 */
function createLogProjection(container, width, height) {
	...
	// LogY (= LinearX Log Y) projection, log requirement: y >0
	var proj = new JenScript.LogYProjection({
		name : "proj log y",
		minX : -1000,
		maxX : 1000,
		minY : 0.001,
