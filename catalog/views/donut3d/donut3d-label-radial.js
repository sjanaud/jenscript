...
/**
 * Create Donut3D radial label
 * @param container
 * @param width
 * @param height
 */
function createDonut3DLabelRadial(container, width, height) {
	...
	var s1Label = new JenScript.Donut3DRadialLabel({
		text : "Silver",
		fillColor:'black',
	...
	var s2Label = new JenScript.Donut3DRadialLabel({
		text : "Platinium",
		fillColor:'black',
	...
	var s3Label = new JenScript.Donut3DRadialLabel({
		text : "Rhodium",
		fillColor:'black',
	...
	var s4Label = new JenScript.Donut3DRadialLabel({
		text : "Silicium",
		fillColor:'black',
